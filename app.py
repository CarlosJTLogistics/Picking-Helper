...
st.caption("Scan QR → trim at 8304 → Pallet set → (optional) lookup fills SKU/LOT/Location → choose QTY staged → Log / Tag")
...
def on_scan():
    ...
    # 2) Try rich parsing of content after 8304 (if present)
